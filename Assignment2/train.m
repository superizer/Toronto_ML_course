...
word_embedding_weights = init_wt * randn(vocab_size, numhid1); % zeros(vocab_size, numhid1); %
embed_to_hid_weights = init_wt * randn(numwords * numhid1, numhid2); % zeros(numwords * numhid1, numhid2); %
hid_to_output_weights = init_wt * randn(numhid2, vocab_size); % zeros(numhid2, vocab_size); %
